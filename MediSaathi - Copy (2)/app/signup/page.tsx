...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const result = await apiClient.users.signUp(userData)
                ...
                <form onSubmit={handleEmailSignup}>
                  ...
                  <TabsContent value="doctor" className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input name="password" id="doc-password" type="password" minLength={6} required />
                    </div>
                    <Button type="submit" className="w-full" disabled={isLoading}>
                  ...
                  <TabsContent value="hospital" className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="license">Hospital License</Label>
                      <Input name="license" id="license" placeholder="HOSP-123456" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="hosp-password">Password</Label>
                      <Input name="password" id="hosp-password" type="password" minLength={6} required />
                    </div>
                    <Button type="submit" className="w-full" disabled={isLoading}>
