...
"[project]/app/api/vitals/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (action === 'latest' || !action) {
            ...
            const { data: vitals, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('vital_signs').select(`
          id,
          type,
          value,
          unit,
...
async function POST(request) {
    try {
        ...
        const { data: vital, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('vital_signs').insert({
            user_id,
            type,
            value,
            unit: unit || '',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4cd4c1c._.js.map