...
"[project]/MediSaathi/lib/services/appointment.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AppointmentService {
    ...
    static async getPatientAppointments(patientId, status) {
        try {
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select(`
          *,
          doctors:doctor_id(
            id,
    ...
    static async bookAppointment(appointmentData) {
        try {
            // Check for conflicts
            const { data: conflicts } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select('*').eq('doctor_id', appointmentData.doctor_id).eq('appointment_date', appointmentData.appointment_date).eq('appointment_time', appointmentData.appointment_time).neq('status', 'cancelled');
            if (conflicts && conflicts.length > 0) {
                throw new Error('Time slot already booked');
            }
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').insert(appointmentData).select(`
          *,
          doctors:doctor_id(
            users!doctors_user_id_fkey(full_name),
            specialty,
    ...
    static async updateAppointment(appointmentId, updates) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').update(updates).eq('id', appointmentId).select().single();
            if (error) throw error;
            return {
                data,
                error: null
    ...
    static async cancelAppointment(appointmentId, reason) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').update({
                status: 'cancelled',
    ...
    static async getAvailableSlots(doctorId, date) {
        try {
            ...
            const [doctorData, appointmentsData] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('doctors').select('available_hours, available_days').eq('id', doctorId).single(),
                __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select('appointment_time, duration').eq('doctor_id', doctorId).eq('appointment_date', date).neq('status', 'cancelled')
            ]);
    ...
    static async getAppointmentStats(doctorId, hospitalId, startDate, endDate) {
        try {
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select('status, type, created_at');
    ...
    static async getUpcomingAppointments(userId, userType) {
        ...
        `).gte('appointment_date', today).lte('appointment_date', nextWeek).in('status', [
            ...
            if (userType === 'patient') {
                ...
                const { data: doctorData } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('doctors').select('id').eq('user_id', userId).single();
                if (doctorData) {
    ...
    static async sendReminders() {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select(`
          *,
...
"[project]/MediSaathi/app/api/appointments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/MediSaathi/lib/supabase.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$services$2f$appointment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/MediSaathi/lib/services/appointment.service.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        ...
        if (doctorId && date) {
            ...
            const { data: appointments, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select(`
          id,
          appointment_date,
          appointment_time,
          status,
    ...
    try {
        ...
        switch(action){
            case 'book':
                ...
                const bookResult = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$services$2f$appointment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppointmentService"].bookAppointment(appointmentData);
...
async function PUT(request) {
    try {
        ...
        switch(action){
            case 'update':
                const updateResult = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$services$2f$appointment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppointmentService"].updateAppointment(appointmentId, updates);
            ...
            case 'cancel':
                const cancelResult = await __TURBOPACK__imported__module__$5b$project$5d2f$MediSaathi$2f$lib$2f$services$2f$appointment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppointmentService"].cancelAppointment(appointmentId, reason);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d46f35d5._.js.map